...
describe UsersController, :type => :controller do
  ...
  describe "invalid login" do
    ...
    it "should only allow passwords of at least 8 characters" do
      user = User.create invalid_password
      expect(user).to be_invalid
    end

    it "should check that the password and the password confirmation are the same" do
      user = User.create invaild_confirmation
      expect(user).to be_invalid
    end
  end
